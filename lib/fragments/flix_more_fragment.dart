              ...
              children: <Widget>[
                ...
                Expanded(
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: <Widget>[
                      Text('Ali',style: TextStyle(fontFamily: font_bold,color: muvi_textColorPrimary),),
                      // text(
                      //   userName,
                      ...
                      // ),
                      Text('Ali@gmail.com',style: TextStyle(fontFamily: font_bold,color: muvi_textColorPrimary),),
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: <Widget>[
                  ...
                  itemSubTitle(context, "Terms").paddingOnly(left: spacing_standard_new,
                      right: 12, top: spacing_standard_new, bottom: spacing_control),
